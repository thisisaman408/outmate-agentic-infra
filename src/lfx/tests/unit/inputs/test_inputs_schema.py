...
from lfx.io.schema import schema_to_outmate_inputs
...
def test_schema_to_outmate_inputs():
    ...
    # Convert schema to outmate_inputs
    inputs = schema_to_outmate_inputs(TestSchema)
...
def test_schema_to_outmate_inputs_invalid_type():
    ...
    with pytest.raises(TypeError, match="Unsupported field type:"):
        schema_to_outmate_inputs(InvalidSchema)
