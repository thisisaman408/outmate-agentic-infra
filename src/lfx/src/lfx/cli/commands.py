...
async def serve_command(
    ...
    *,
    ...
    try:
        api_key = get_api_key()
        verbose_print("✓ OutmateAPI_KEY is configured")
    except ValueError as e:
        typer.echo(f"✗ {e}", err=True)
        typer.echo("Set the OutmateAPI_KEY environment variable before serving.", err=True)
    ...
    os.environ["OutmatePRETTY_LOGS"] = "false"
