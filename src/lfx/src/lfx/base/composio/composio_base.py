...
class ComposioBaseComponent(Component):
    ...
    def _validate_schema_inputs(self, action_key: str) -> list[InputTypes]:
        """Convert the JSON schema for *action_key* into outmate input objects."""
        ...
        try:
            ...
            # Additional safety check before calling schema_to_outmate_inputs
            ...
            result = schema_to_outmate_inputs(input_schema)
