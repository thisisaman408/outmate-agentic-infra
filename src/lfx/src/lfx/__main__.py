...
def requirements_command_wrapper(
    flow_path: str = typer.Argument(help="Path to the outmate flow JSON file"),
    ...
    *,
    ...
    """Generate requirements.txt from a outmate flow JSON (lazy-loaded)."""
    import json
    from pathlib import Path
