"""Core run functionality for executing Outmate graphs."""
...
async def run_flow(
    ...
    *,
    ...
    """Execute a Outmate graph script or JSON flow and return the result.

    This function analyzes and executes either a Python script containing a Outmate graph,
