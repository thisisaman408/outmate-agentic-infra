...
USER_AGENT = None
# Check if Outmate is installed using importlib.util.find_spec(name))
if importlib.util.find_spec("outmate"):
    outmate_installed = True
    USER_AGENT = get_user_agent()
else:
    outmate_installed = False
    USER_AGENT = "lfx"
...
class URLComponent(Component):
    ...
    documentation: str = "https://docs.outmate.org/url"
