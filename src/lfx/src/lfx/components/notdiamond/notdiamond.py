...
ND_MODEL_MAPPING = {
    ...
    # Backward compatibility aliases for old Anthropic model identifiers
    "claude-3-5-sonnet-20241022": {"provider": "anthropic", "model": "claude-sonnet-4-20250514"},
    "claude-3-opus-20240229": {"provider": "anthropic", "model": "claude-opus-4-20250514"},
    "claude-3-5-haiku-20241022": {"provider": "anthropic", "model": "claude-sonnet-4-20250514"},
    "anthropic.claude-3-5-sonnet-20241022-v2:0": {"provider": "anthropic", "model": "claude-sonnet-4-20250514"},
    "anthropic.claude-3-5-haiku-20241022-v1:0": {"provider": "anthropic", "model": "claude-sonnet-4-20250514"},
    # Google models
    "gemini-2.5-pro": {"provider": "google", "model": "gemini-2.5-pro"},
    "gemini-2.5-flash": {"provider": "google", "model": "gemini-2.5-flash"},
    # Backward compatibility aliases for old Google model identifiers
    "gemini-1.5-pro": {"provider": "google", "model": "gemini-2.5-pro"},
    "gemini-1.5-flash": {"provider": "google", "model": "gemini-2.5-flash"},
    # Perplexity models
