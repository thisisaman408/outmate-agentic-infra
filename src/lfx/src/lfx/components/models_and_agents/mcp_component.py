...
from lfx.io.schema import flatten_schema, schema_to_outmate_inputs
...
class MCPToolsComponent(ComponentWithCache):
    ...
    documentation: str = "https://docs.outmate.org/mcp-tools"
    icon = "Mcp"
    name = "MCPTools"
    ...
    async def _validate_schema_inputs(self, tool_obj) -> list[InputTypes]:
        ...
        try:
            ...
            schema_inputs = schema_to_outmate_inputs(input_schema)
    ...
    async def update_tool_list(self, mcp_server_value=None):
        ...
        try:
            ...
            try:
                from outmate.api.v2.mcp import get_server
                from outmate.services.database.models.user.crud import get_user_by_id

                from lfx.services.deps import get_settings_service
            except ImportError as e:
                msg = (
                    "Outmate MCP server functionality is not available. "
                    "This feature requires the full Outmate installation."
                )
    ...
    def get_inputs_for_all_tools(self, tools: list) -> dict:
        ...
        for tool in tools:
            ...
            try:
                ...
                input_schema = create_input_schema_from_json_schema(flat_schema)
                outmate_inputs = schema_to_outmate_inputs(input_schema)
                inputs[tool.name] = outmate_inputs
    ...
    async def build_output(self) -> DataFrame:
        ...
        try:
            ...
            if self.tool != "":
                # Set session context for persistent MCP sessions using Outmate session ID
    ...
    def _get_session_context(self) -> str | None:
        """Get the Outmate session ID for MCP session caching."""
