"""Generate requirements.txt from an Outmate flow JSON.
...
# Import names that are internal to the lfx/Outmate runtime and should
# never appear as separate requirements.
_INTERNAL_IMPORT_NAMES: frozenset[str] = frozenset({"lfx", "outmate", "outmate_base"})
        ...
        if source and isinstance(source, str):
            ...
            for imp in imports:
                ...
                if imp in STDLIB_MODULES:
                    continue
                # Skip lfx / Outmate internal imports - lfx provides these
...
def generate_requirements_from_flow(
    ...
    *,
    ...
    """Generate a requirements list from a Outmate flow JSON.

    Args:
        flow: Parsed Outmate flow JSON (dict).
...
def generate_requirements_txt(
    ...
    *,
    ...
    """Generate requirements.txt content from a Outmate flow JSON.
    ...
    lines = [
        "# Auto-generated requirements for Outmate flow",
...
def generate_requirements_from_file(
    ...
    *,
    ...
    Args:
        flow_path: Path to a Outmate flow JSON file.
        lfx_package: Name of the LFX package to include.
        include_lfx: Whether to include the LFX package itself.
        pin_versions: If True, pin each package to the currently installed
            version.
