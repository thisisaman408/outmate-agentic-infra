...
from outmate.services.store.exceptions import APIKeyError, FilterError, ForbiddenError
...
from outmate.services.store.utils import (
...
def get_id_from_search_string(search_string: str) -> str | None:
    ...
    if "www.outmatestore/store/" in search_string:
...
class StoreService(Service):
    """This is a service that integrates Outmate with the store which is a Directus instance.
