...
from outmate.services.database import models
from outmate.services.database.models.user.crud import get_user_by_username
from outmate.services.database.session import NoopSession
from outmate.services.database.utils import Result, TableResults
...
class DatabaseService(Service):
    ...
    def __init__(self, settings_service: SettingsService):
        ...
        # This file is in outmate.services.database.manager.py
        # the ini is in Outmate
        outmate_dir = Path(__file__).parent.parent.parent
        self.script_location = outmate_dir / "alembic"
        self.alembic_cfg_path = outmate_dir / "alembic.ini"
        ...
        if self.alembic_log_to_stdout:
            ...
            self.alembic_log_path = Path(outmate_dir) / alembic_log_file
