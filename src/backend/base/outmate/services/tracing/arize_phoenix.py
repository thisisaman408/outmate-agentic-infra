...
class CollectingSpanProcessor(SpanProcessor):
    ...
    def on_start(self, span, parent_context=None):
        ...
        if span.name in ("outmate", "Language Model"):
            span.set_attribute("outmate_correlation_id", self.correlation_id)
...
class ArizePhoenixTracer(BaseTracer):
    ...
    def __init__(
        ...
        try:
            ...
            self.root_span.set_attribute("outmate_trace_name", self.trace_name)
            self.root_span.set_attribute("outmate_trace_type", self.trace_type)
            self.root_span.set_attribute("outmate_project_name", self.project_name)
            self.root_span.set_attribute("outmate_trace_id", str(self.trace_id))
            self.root_span.set_attribute("outmate_session_id", str(self.session_id))
            self.root_span.set_attribute("outmate_flow_name", self.flow_name)
            self.root_span.set_attribute("outmate_flow_id", self.flow_id)
