...
from outmate.exceptions.api import WorkflowResourceError, WorkflowServiceUnavailableError
from outmate.services.base import Service
from outmate.services.deps import get_queue_service
from outmate.services.task.backends.anyio import AnyIOBackend
from outmate.services.task.backends.celery import CeleryBackend

if TYPE_CHECKING:
    from lfx.services.settings.service import SettingsService

    from outmate.services.task.backends.base import TaskBackend
...
class TaskService(Service):
    ...
    async def revoke_task(self, task_id: UUID | str) -> bool:
        ...
        try:
            ...
            if str(e) != "OutmateUSER_CANCELLED":
                raise
            return True
        return True
