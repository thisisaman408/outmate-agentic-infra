...
from outmate.services.database.models.jobs.crud import (
    get_job_by_job_id,
    get_jobs_by_flow_id,
    get_latest_jobs_by_asset_ids,
    update_job_status,
)
from outmate.services.database.models.jobs.model import Job, JobStatus, JobType
...
class JobService(Service):
    ...
    async def execute_with_status(self, job_id: UUID, run_coro_func, *args, **kwargs):
        ...
        try:
            ...
            if exc.args and exc.args[0] == "OutmateUSER_CANCELLED":
