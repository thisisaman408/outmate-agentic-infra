...
from outmate.services.auth.constants import AUTO_LOGIN_ERROR, AUTO_LOGIN_WARNING
...
from outmate.services.database.models.user.crud import (
    get_user_by_id,
...
class AuthService(BaseAuthService):
    """Default Outmate authentication service (implements LFX BaseAuthService)."""
    ...
    async def _authenticate_with_token(self, token: str, db: AsyncSession) -> User:
        ...
        from outmate.services.auth.utils import ACCESS_TOKEN_TYPE, get_jwt_verification_key
