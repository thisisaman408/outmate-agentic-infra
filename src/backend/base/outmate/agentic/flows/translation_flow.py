...
Usage:
    from outmate.agentic.flows.translation_flow import get_graph
...
- "generate_component": User wants you to CREATE/BUILD/GENERATE a custom Outmate component for them
...
Examples:
Input: "como criar um componente no Outmate
Output: {{"translation": "how to create a component in Outmate, "intent": "question"}}
