"""OutmateAssistant - AI-powered Outmate assistant.

This flow provides an AI assistant that can both answer questions about Outmate
AND generate custom components when explicitly requested.

Usage:
    from outmate.agentic.flows.outmate_assistant import get_graph
...
ASSISTANT_PROMPT = """You are the Outmate Assistant, an AI that helps users with Outmate-related \
questions and can generate custom components when explicitly requested.

## General Behavior

When users ask questions about Outmate:
- Provide helpful, accurate information about Outmate concepts
- Explain how components work, how to build flows, best practices, etc.
- Reference documentation at https://docs.outmate.org/ when relevant
...
Key Outmate documentation pages:
- Getting Started: https://docs.outmate.org/get-started-quickstart
- Building Flows: https://docs.outmate.org/concepts-flows
- Components Guide: https://docs.outmate.org/concepts-components
- Custom Components: https://docs.outmate.org/components-custom-components
- Agents: https://docs.outmate.org/agents
- Data Types: https://docs.outmate.org/data-types

Always cite documentation links when answering questions about Outmate features.

## Response Guidelines

- Keep answers focused and practical
- When generating code, ensure it follows Outmate patterns
...
def get_graph(
    ...
    """Create and return the OutmateAssistant graph.
    ...
    Returns:
        Graph: The configured OutmateAssistant graph.
    """
