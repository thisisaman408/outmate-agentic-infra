"""FastMCP server for OutmateAgentic tools.
...
from outmate.agentic.mcp.support import replace_none_and_null_with_empty_str
from outmate.agentic.utils.component_search import (
...
from outmate.agentic.utils.flow_component import (
    get_component_details,
    get_component_field_value,
    list_component_fields,
    update_component_field_value,
)
from outmate.agentic.utils.flow_graph import (
    get_flow_ascii_graph,
    get_flow_graph_representations,
    get_flow_graph_summary,
    get_flow_text_repr,
)
from outmate.agentic.utils.template_create import (
    create_flow_from_template_and_get_link,
)
from outmate.agentic.utils.template_search import (
    get_all_tags,
    get_template_by_id,
    get_templates_count,
    list_templates,
