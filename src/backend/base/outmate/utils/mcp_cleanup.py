...
spawned by stdio_client during Outmate shutdown.
...
async def cleanup_mcp_sessions() -> None:
    ...
    with contextlib.suppress(Exception):
        ...
        from outmate.services.deps import get_shared_component_cache_service
...
async def _kill_mcp_processes() -> None:
    """Kill MCP server subprocesses spawned by this outmate_process.
