...
def create_outmate_progress(*, verbose: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Outmate initialization steps."""
    progress = ProgressIndicator(verbose=verbose)

    # Define the initialization steps matching the order in main.py
    steps = [
        ("Initializing Outmate", "Setting up basic configuration"),
        ...
        ("Launching Outmate", "Starting server and final setup"),
    ]
...
def create_outmate_shutdown_progress(*, verbose: bool = False, multiple_workers: bool = False) -> ProgressIndicator:
    """Create a progress indicator with predefined Outmate shutdown steps."""
    progress = ProgressIndicator(verbose=verbose)
