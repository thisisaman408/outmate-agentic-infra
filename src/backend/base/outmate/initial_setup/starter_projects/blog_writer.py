...
""")
    ...
    url_component.set(urls=["https://outmate.org/", "https://docs.outmate.org/"])
    ...
    text_input.set(
        input_value="Use the references above for style to write a new blog/tutorial about Outmate and AI. "
