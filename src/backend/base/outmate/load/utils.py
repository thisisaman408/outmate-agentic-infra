...
from outmate.services.database.models.flow.model import FlowBase


def get_flow(url: str, flow_id: str):
    """Get the details of a flow from Outmate

    Args:
        url (str): The host URL of Outmate
        port (int): The port number of Outmate
