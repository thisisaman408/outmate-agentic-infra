...
from outmate.api.utils import CurrentActiveUser, DbSession, extract_global_variables_from_headers, parse_value
from outmate.api.v1.schemas import (
    ConfigResponse,
...
from outmate.events.event_manager import create_stream_tokens_event_manager
from outmate.exceptions.api import APIException, InvalidChatInputError
from outmate.exceptions.serialization import SerializationError
from outmate.helpers.flow import get_flow_by_id_or_endpoint_name
from outmate.interface.initialize.loading import update_params_with_load_from_db_fields
from outmate.processing.process import process_tweaks, run_graph_internal
from outmate.schema.graph import Tweaks
from outmate.services.auth.utils import (
    api_key_security,
    get_current_active_user,
    get_current_user_for_sse,
    get_optional_user,
)
from outmate.services.cache.utils import save_uploaded_file
from outmate.services.database.models.flow.model import Flow, FlowRead
from outmate.services.database.models.flow.utils import get_all_webhook_components_in_flow
from outmate.services.database.models.user.model import User, UserRead
from outmate.services.deps import get_auth_service, get_session_service, get_settings_service, get_telemetry_service
from outmate.services.event_manager import create_webhook_event_manager, webhook_event_manager
from outmate.services.telemetry.schema import RunPayload
from outmate.utils.compression import compress_response
from outmate.utils.version import get_version_info

if TYPE_CHECKING:
    from outmate.events.event_manager import EventManager
...
async def _run_flow_internal(
    *,
    ...
    # Extract request-level variables from headers with prefix X-OutmateGLOBAL-VAR-*
...
async def simplified_run_flow(
    *,
    ...
    Notes:
        ...
        - Extracts global variables from HTTP headers with prefix X-OutmateGLOBAL-VAR-*
...
# get endpoint to return version of Outmate
@router.get("/version")
