...
from outmate.api.v1.schemas import Token
from outmate.initial_setup.setup import get_or_create_default_folder
from outmate.services.auth.exceptions import AuthenticationError
...
from outmate.services.deps import get_auth_service, get_settings_service, get_variable_service
...
async def get_session(
    ...
    """
    from outmate.services.auth.utils import oauth2_login
    ...
    except (HTTPException, ValueError, AuthenticationError) as _:
