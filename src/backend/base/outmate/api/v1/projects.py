...
from outmate.api.utils import CurrentActiveUser, DbSession, cascade_delete_flow, custom_params, remove_api_keys
from outmate.api.utils.mcp.config_utils import validate_mcp_server_for_project
from outmate.api.v1.auth_helpers import handle_auth_settings_update
from outmate.api.v1.flows import create_flows
...
from outmate.api.v1.schemas import FlowListCreate
from outmate.api.v2.mcp import update_server
from outmate.helpers.flow import generate_unique_flow_name
from outmate.helpers.folders import generate_unique_folder_name
from outmate.initial_setup.constants import ASSISTANT_FOLDER_NAME, STARTER_FOLDER_NAME
from outmate.services.auth.mcp_encryption import encrypt_auth_settings
from outmate.services.database.models.api_key.crud import create_api_key
from outmate.services.database.models.api_key.model import ApiKeyCreate
from outmate.services.database.models.flow.model import Flow, FlowCreate, FlowRead
from outmate.services.database.models.folder.constants import DEFAULT_FOLDER_NAME
from outmate.services.database.models.folder.model import (
    Folder,
    FolderCreate,
    FolderRead,
    FolderReadWithFlows,
...
from outmate.services.database.models.folder.pagination_model import FolderWithPaginatedFlows
from outmate.services.deps import get_service, get_settings_service, get_storage_service
...
async def delete_project(
    *,
    ...
    # Prevent deletion of the OutmateAssistant folder
