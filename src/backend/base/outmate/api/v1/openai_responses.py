...
from outmate.api.utils import extract_global_variables_from_headers
from outmate.api.v1.endpoints import consume_and_yield, run_flow_generator, simple_run_flow
from outmate.api.v1.schemas import SimplifiedAPIRequest
...
from outmate.schema import (
    OpenAIErrorResponse,
    OpenAIResponsesRequest,
    OpenAIResponsesResponse,
    OpenAIResponsesStreamChunk,
)
from outmate.schema.content_types import ToolContent
from outmate.services.auth.utils import api_key_security
from outmate.services.database.models.flow.model import FlowRead
from outmate.services.database.models.user.model import UserRead
from outmate.services.deps import get_telemetry_service
from outmate.services.telemetry.schema import RunPayload
from outmate.services.telemetry.service import TelemetryService
    ...
    *,
    ...
    if stream:
        ...
        async def openai_stream_generator() -> AsyncGenerator[str, None]:
            """Convert Outmate events to OpenAI Responses API streaming format."""
...
async def create_response(
    ...
    the input through the specified Outmate flow.
    ...
    # Extract global variables from X-OutmateGLOBAL-VAR-* headers
