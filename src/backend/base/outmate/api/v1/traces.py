...
Business logic (query/aggregation) lives in:
    outmate.services.tracing.repository

Data transformation logic lives in:
    outmate.services.tracing.formatting
"""
...
from outmate.services.tracing.repository import fetch_single_trace, fetch_traces
from outmate.services.tracing.validation import sanitize_query_string
