...
from outmate.api.utils import CurrentActiveUser, check_outmate_version
from outmate.services.auth import utils as auth_utils
from outmate.services.deps import get_settings_service, get_store_service
from outmate.services.store.exceptions import CustomError
from outmate.services.store.schema import (
...
async def share_component(
    ...
    try:
        await check_outmate_version(component)
