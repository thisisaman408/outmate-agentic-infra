...
def main():
    """Launches Outmate with appropriate environment setup.
...
def _launch_with_exec():
    """Launch Outmate by replacing current process with properly configured environment.
    ...
    try:
        os.execv(sys.executable, [sys.executable, "-m", "outmate.__main__", *sys.argv[1:]])  # noqa: S606
    except OSError as e:
