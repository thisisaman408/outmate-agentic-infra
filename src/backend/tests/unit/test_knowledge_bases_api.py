...
from outmate.api.utils.kb_helpers import (
    KBAnalysisHelper,
    KBIngestionHelper,
    KBStorageHelper,
)
...
class TestGetKBMetaData:
    ...
    @patch("outmate.api.utils.kb_helpers.KBAnalysisHelper._detect_embedding_provider")
    @patch("outmate.api.utils.kb_helpers.KBAnalysisHelper._detect_embedding_model")
    @patch("outmate.api.utils.kb_helpers.KBStorageHelper.get_directory_size")
...
class TestKnowledgeBaseAPI:
    ...
    @patch("outmate.api.v1.knowledge_bases.KBStorageHelper.get_fresh_chroma_client")
    @patch("outmate.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("outmate.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    @patch("outmate.api.v1.knowledge_bases.KBAnalysisHelper.get_metadata")
    @patch("outmate.api.v1.knowledge_bases.get_job_service")
    ...
    @patch("outmate.api.v1.knowledge_bases.KBStorageHelper.teardown_storage")
    @patch("outmate.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    ...
    @patch("outmate.api.v1.knowledge_bases.KBAnalysisHelper.get_metadata")
    @patch("outmate.api.v1.knowledge_bases.get_job_service")
    @patch("outmate.api.v1.knowledge_bases.get_task_service")
    ...
    @patch("outmate.api.v1.knowledge_bases.KBStorageHelper.get_fresh_chroma_client")
    @patch("outmate.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    @patch("outmate.api.v1.knowledge_bases.Chroma")
...
class TestPerformIngestionTask:
    ...
    @patch("outmate.api.utils.kb_helpers.KBStorageHelper.get_fresh_chroma_client")
    @patch("outmate.api.utils.kb_helpers.Chroma")
    @patch("outmate.api.utils.kb_helpers.KBIngestionHelper._build_embeddings", new_callable=AsyncMock)
    @patch("outmate.api.utils.kb_helpers.KBAnalysisHelper.get_metadata")
    @patch("outmate.api.utils.kb_helpers.KBStorageHelper.get_directory_size")
    @patch("outmate.api.utils.kb_helpers.KBAnalysisHelper.update_text_metrics")
    ...
    @patch("outmate.api.utils.kb_helpers.Chroma")
    @patch("outmate.api.utils.kb_helpers.KBIngestionHelper._build_embeddings", new_callable=AsyncMock)
    @patch("outmate.api.utils.kb_helpers.KBIngestionHelper.cleanup_chroma_chunks_by_job", new_callable=AsyncMock)
...
class TestCancelIngestion:
    ...
    @patch("outmate.api.v1.knowledge_bases.KBIngestionHelper.cleanup_chroma_chunks_by_job")
    @patch("outmate.api.v1.knowledge_bases.KBStorageHelper.get_root_path")
    @patch("outmate.api.v1.knowledge_bases.KBAnalysisHelper.get_metadata")
    async def test_cancel_ingestion_success(
        ...
        from outmate.services.deps import get_service
        ...
        with mock_patch("outmate.services.deps.get_service", side_effect=get_service_side_effect):
            response = await client.post(
