...
import pytest
from outmate.agentic.helpers.code_extraction import extract_python_code
from outmate.agentic.helpers.sse import (
    format_complete_event,
    format_error_event,
    format_progress_event,
)
from outmate.agentic.helpers.validation import validate_component_code
from outmate.agentic.services.assistant_service import (
    execute_flow_with_validation,
    execute_flow_with_validation_streaming,
)
from outmate.agentic.services.flow_types import (
...
INVALID_COMPONENT_CODE = """from outmate.custom import Component
from outmate.io import MessageTextInput, Output
...
class TestStreamingValidationFlow:
    ...
    async def test_valid_code_first_try_returns_validated(self):
        ...
        with (
            patch(
                "outmate.agentic.services.assistant_service.classify_intent",
                side_effect=_mock_intent_classification("generate_component"),
            ),
            patch(
                "outmate.agentic.services.assistant_service.execute_flow_file_streaming",
    ...
    async def test_no_code_in_response_returns_as_is(self):
        ...
        text_only_response = {"result": "Outmate is a visual flow builder for LLM applications."}
...
class TestNonStreamingValidation:
    ...
    async def test_non_streaming_valid_code_returns_validated(self):
        ...
        with patch(
            "outmate.agentic.services.assistant_service.execute_flow_file",
