...
import pytest
from outmate.agentic.services.provider_service import get_enabled_providers_for_user
...
class TestGetEnabledProvidersForUserMulti:
    ...
    async def test_should_enable_provider_when_all_required_vars_present(self):
        ...
        with patch("outmate.agentic.services.provider_service.get_variable_service") as mock_get_service:
            from outmate.services.variable.service import DatabaseVariableService
            ...
            with patch(
                "outmate.agentic.services.provider_service.get_provider_required_variable_keys"
            ) as mock_get_keys:
                ...
                with patch(
                    "outmate.agentic.services.provider_service.get_model_provider_variable_mapping"
                ) as mock_get_map:
