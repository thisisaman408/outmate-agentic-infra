...
class TestConstants:
    ...
    def test_outmate_assistant_flow_should_be_string(self):
        """OUTMATE_ASSISTANT_FLOW should be a non-empty string."""
        assert isinstance(OUTMATE_ASSISTANT_FLOW, str)
        assert len(OUTMATE_ASSISTANT_FLOW) > 0
