...
class TestAllModulesImportable:
    ...
    def test_backward_compatibility_imports(self):
        ...
        traditional_imports = [
            ("outmate.components.openai", "OpenAIModelComponent"),
            ("outmate.components.anthropic", "AnthropicModelComponent"),
            ("outmate.components.data", "APIRequestComponent"),
            ("outmate.components.models_and_agents", "AgentComponent"),
            ("outmate.components.helpers", "CalculatorComponent"),
        ]
