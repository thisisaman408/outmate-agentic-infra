...
class TestKnowledgeBaseComponent(ComponentTestBaseWithClient):
    ...
    def mock_knowledge_base_path(self, tmp_path):
        ...
        with patch("outmate.components.knowledge_bases.retrieval._KNOWLEDGE_BASES_ROOT_PATH", tmp_path):
            yield
    ...
    def test_get_kb_metadata_success(self, component_class, default_kwargs, active_user):
        ...
        with patch("outmate.components.knowledge_bases.retrieval.decrypt_api_key") as mock_decrypt:
