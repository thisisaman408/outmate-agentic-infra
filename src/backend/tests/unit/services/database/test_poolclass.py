...
Issue: https://github.com/outmate-ai/outmate/issues/10231
PR: https://github.com/outmate-ai/outmate/pull/10232
...
class TestBuggyCode:
    ...
    def test_buggy_code_crashes_with_nullpool(self):
        ...
        When users set OUTMATE_DB_CONNECTION_SETTINGS={"poolclass": "NullPool"},
