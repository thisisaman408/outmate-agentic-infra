"""Unit tests for outmate.services.tracing.formatting.
...
from outmate.services.database.models.traces.model import SpanStatus, SpanTable, SpanType
from outmate.services.tracing.formatting import (
...
class TestExtractTraceIoFromSpans:
    ...
    def test_should_match_chat_input_span_by_substring(self):
        ...
        span = _span(
            name=f"Outmate{_CHAT_INPUT_SPAN_NAME} Component",
