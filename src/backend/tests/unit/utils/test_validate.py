...
from lfx.custom.validate import (
    _create_outmate_execution_context,
    add_type_ignores,
...
class TestCreateOutmateExecutionContext:
    """Test cases for _create_outmate_execution_context function."""

    def test_creates_context_with_outmate_imports(self):
        """Test that context includes outmate imports."""
        # The function imports modules inside try/except blocks
        # We don't need to patch anything, just test it works
        context = _create_outmate_execution_context()
    ...
    def test_does_not_include_pandas(self):
        """Test that pandas is not included in the outmate execution context."""
        context = _create_outmate_execution_context()
...
"""
    ...
    def test_replaces_legacy_imports(self):
        ...
        code = """
from outmate import CustomComponent
...
class TestGetDefaultImports:
    ...
    def test_includes_outmate_imports(self):
        """Test that outmate imports are included when found in code."""
