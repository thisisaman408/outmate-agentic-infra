from outmate.processing.process import process_tweaks
from outmate.services.deps import get_session_service
from outmate.services.utils import register_all_service_factories
...
def test_apply_tweaks_code_override_prevention():
    ...
    from outmate.processing.process import apply_tweaks
    ...
    # Capture log output
    with patch("outmate_processing.process.logger") as mock_logger:
