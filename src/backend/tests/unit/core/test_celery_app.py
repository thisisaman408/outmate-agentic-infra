"""Unit tests for outmate.core.celery_app module."""
...
class TestMakeCelery:
    ...
    def test_make_celery_creates_celery_instance(self):
        ...
        from outmate.core.celery_app import make_celery
        ...
        with patch.dict("sys.modules", {"outmate.core.celeryconfig": mock_config}):
            # Act - Create a real Celery instance
            celery_app = make_celery("test_app", "outmate.core.celeryconfig")
    ...
    def test_make_celery_sets_task_routes(self):
        ...
        with patch.dict("sys.modules", {"outmate.core.celeryconfig": mock_config}):
            app1 = make_celery("app1", "outmate.core.celeryconfig")
            app2 = make_celery("app2", "outmate.core.celeryconfig")
    ...
    def test_make_celery_with_different_configs(self):
        ...
        with patch.dict("sys.modules", {"outmate.core.celeryconfig": mock_config1}):
            app1 = make_celery("test_app", "outmate.core.celeryconfig")
            assert app1.conf.broker_url == "redis://test1:6379/0"

        with patch.dict("sys.modules", {"outmate.core.celeryconfig": mock_config2}):
            app2 = make_celery("test_app", "outmate.core.celeryconfig")
    ...
    def test_make_celery_error_handling(self):
        ...
        with patch("outmate.core.celery_app.Celery") as mock_celery_class:
    ...
    def test_make_celery_configuration_application(self):
        ...
        from outmate.core.celery_app import celery_app
        ...
        assert celery_app.main == "outmate"
