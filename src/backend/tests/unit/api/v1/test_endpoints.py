...
from outmate.api.v1.schemas import CustomComponentRequest, UpdateCustomComponentRequest
...
async def test_get_config_returns_500_on_settings_error(client: AsyncClient, monkeypatch):
    ...
    monkeypatch.setattr("outmate.api.v1.endpoints.get_settings_service", raise_settings_error)
