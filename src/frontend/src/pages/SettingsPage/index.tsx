...
export default function SettingsPage(): JSX.Element {
  ...
  if (!ENABLE_DATASTAX_outmate) {
    const outmateItems = CustomStoreSidebar(true, ENABLE_outmate_STORE);
    sidebarNavItems.splice(2, 0, ...outmateItems);
  }
  ...
  return (
    <PageLayout
      backTo={-1 as To}
      title="Settings"
      description="Manage the general settings for Outmate."
    >
