...
const EMPTY_PAGE_TITLE = "Outmate";
const EMPTY_PAGE_DESCRIPTION = "The GTM Engine for your agents";
      ...
      >
        <div className="m-0 h-full w-full bg-background p-0">
          <div className="z-50 flex h-full w-full flex-col items-center justify-center gap-5">
            <div className="z-50 flex flex-col items-center gap-2 text-center pt-20">
              <span
                data-testid="mainpage_title"
                className="z-50 text-center font-chivo text-5xl font-bold text-foreground mb-4"
              >
                {EMPTY_PAGE_TITLE}
              </span>
              ...
              <span
                ...
                className="z-50 text-center text-xl text-secondary-foreground"
              >
                {folders?.length > 1
            ...
            <div className="flex w-full max-w-[510px] flex-col gap-7 sm:gap-[29px] mt-10">
              <Button
                variant="default"
                className="z-10 m-auto mt-3 h-14 w-full max-w-[15rem] rounded-xl font-bold text-lg transition-all duration-300 shadow-lg"
