import {
    IS_AUTO_LOGIN,
    outmate_ACCESS_TOKEN_EXPIRE_SECONDS,
    outmate_ACCESS_TOKEN_EXPIRE_SECONDS_ENV,
...
export const ProtectedRoute = ({ children }) => {
  ...
  useEffect(() => {
    const envRefreshTime = outmate_ACCESS_TOKEN_EXPIRE_SECONDS_ENV;
    const automaticRefreshTime = outmate_ACCESS_TOKEN_EXPIRE_SECONDS;
