...
jest.mock("@/constants/constants", () => ({
  ...
  DOCS_URL: "https://docs.outmate.org",
  DESKTOP_URL: "https://desktop.outmate.org",
}));

jest.mock("@/customization/feature-flags", () => ({
  ENABLE_DATASTAX_outmate: false,
}));
...
describe("HelpDropdown", () => {
  ...
  it("opens docs in new tab and navigates to shortcuts", () => {
    ...
    fireEvent.click(
      screen.getByTestId("canvas_controls_dropdown_get_outmate_desktop"),
    );
    expect(window.open).toHaveBeenCalledWith(
      "https://desktop.outmate.org",
      "_blank",
    );
  });
});
