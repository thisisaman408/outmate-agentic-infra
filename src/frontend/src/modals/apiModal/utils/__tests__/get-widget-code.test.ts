...
describe("getWidgetCode", () => {
  ...
  describe("Basic widget code generation", () => {
    it("should generate widget code with API key when isAuth is false", () => {
      ...
      expect(code).toContain(
        "https://cdn.jsdelivr.net/gh/logspace-ai/outmate-embedded-chat",
      );
      expect(code).toContain("@v1.0.7");
      expect(code).toContain("</script>");

      // Check for outmate-chat component
      expect(code).toContain("<outmate-chat");
    ...
    it("should generate widget code without API key when isAuth is true", () => {
      ...
      expect(code).toContain("<script");
      expect(code).toContain(
        "https://cdn.jsdelivr.net/gh/logspace-ai/outmate-embedded-chat@v1.0.7",
      );
    ...
    it("should use formatted CDN URL when copy is true", () => {
      ...
      expect(code).toContain(
        "https://cdn.jsdelivr.net/gh/logspace-ai/outmate-embedded-chat@v1.0.7/dist/build/static/js/bundle.min.js",
      );
  ...
  describe("Code structure", () => {
    it("should have proper HTML structure with script and outmate-chat tags", () => {
      const code = getWidgetCode(baseOptions);
      ...
      // Check for opening and closing outmate-chat tags
      expect(code).toContain("<outmate-chat");
      expect(code).toContain("</outmate-chat>");
    });

    it("should have all required attributes in outmate-chat component", () => {
      const code = getWidgetCode(baseOptions);
