//import outmateLogoColor from "@/assets/outmateLogocolor.svg?react";
...
import { outmateButtonRedirectTarget } from "@/customization/utils/urls";
...
export default function IOModal({
  ...
  const outmateButtonClick = () => {
    track("outmateButtonClick");
    customOpenNewTab(outmateButtonRedirectTarget());
  };
              ...
              >
                ...
                {sidebarOpen && showPublishOptions && (
                  <div className="absolute bottom-2 left-0 flex w-full flex-col gap-8 border-t border-border px-2 py-4 transition-all">
                    ...
                    <Button
                      onClick={outmateButtonClick}
                      variant="primary"
                      className="w-full !rounded-xl shadow-lg"
                    >
                      <IconComponent name="Sparkles" className="h-4 w-4 mr-2" />
                      <div className="text-sm">Built with Outmate</div>
                    </Button>
                  </div>
                )}
              </div>
              ...
              <div className="absolute bottom-6 left-4 hidden transition-all md:block">
                ...
                >
                  <Button
                    ...
                    onClick={outmateButtonClick}
                  >
                    <IconComponent name="Sparkles" className="h-5 w-5" />
                  </Button>
                </ShadTooltip>
              </div>
            )}
