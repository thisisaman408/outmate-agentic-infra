...
export function AuthProvider({ children }): React.ReactElement {
  ...
  function login(
    ...
    cookieManager.set(outmate_ACCESS_TOKEN, newAccessToken);
    cookieManager.set(outmate_AUTO_LOGIN_OPTION, autoLogin);
    setLocalStorage(outmate_ACCESS_TOKEN, newAccessToken);

    if (refreshToken) {
      cookieManager.set(outmate_REFRESH_TOKEN, refreshToken);
    }
  ...
  function clearAuthSession() {
    ...
    localStorage.removeItem(outmate_ACCESS_TOKEN);
    localStorage.removeItem(outmate_API_TOKEN);
    localStorage.removeItem(outmate_REFRESH_TOKEN);
    setAccessToken(null);
    setApiKey(null);
    setUserData(null);
