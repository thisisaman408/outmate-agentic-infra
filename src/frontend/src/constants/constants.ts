...
export const CODE_PROMPT_DIALOG_SUBTITLE =
  "Edit your Python code snippet. Refer to the outmate documentation for more information on how to write your own component.";
...
export const DESCRIPTIONS: string[] = [
  ...
  "outmate: Create, Chain, Communicate.",
...
export const API_PAGE_PARAGRAPH =
  "Your secret Outmate API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const outmate_SUPPORTED_TYPES = new Set([
  "str",
  "bool",
  "float",
  "code",
...
export const outmate_CHAT_TITLE = "outmate Chat";
...
export const STORE_TITLE = "outmate Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your outmate API key.";
...
export const outmate_ACCESS_TOKEN = "access_token_lf";
export const outmate_API_TOKEN = "apikey_tkn_lflw";
export const outmate_AUTO_LOGIN_OPTION = "auto_login_lf";
export const outmate_REFRESH_TOKEN = "refresh_token_lf";

export const outmate_ACCESS_TOKEN_EXPIRE_SECONDS = 60 * 60 - 60 * 60 * 0.1;
export const outmate_ACCESS_TOKEN_EXPIRE_SECONDS_ENV =
...
export const IS_AUTO_LOGIN = true;
...
export const DISCORD_URL = "https://outmate.com/discord";
export const GITHUB_URL = "https://github.com/outmate/outmate";
export const TWITTER_URL = "https://x.com/outmate";
export const DOCS_URL = "https://docs.outmate.com";
export const DATASTAX_DOCS_URL =
  "https://docs.outmate.com";
export const DESKTOP_URL = "https://www.outmate.com/desktop";
export const BUG_REPORT_URL = "https://github.com/outmate/outmate/issues";
