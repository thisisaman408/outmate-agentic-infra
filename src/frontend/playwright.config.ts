...
export default defineConfig({
  ...
  webServer: [
    {
      command:
        "uv run uvicorn --factory outmate.main:create_app --host localhost --port 7860 --loop asyncio --log-level error --no-access-log",
      port: 7860,
      env: {
        outmate_DATABASE_URL: "sqlite:///./temp",
        outmate_AUTO_LOGIN: "true",
        outmate_DEACTIVATE_TRACING: "true",
