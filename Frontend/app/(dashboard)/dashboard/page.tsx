        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between px-6 py-4 border-b border-border gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground font-medium">Real-time visitor identification</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            {AGENTIC_INFRA_URL && (
              <a
                href={AGENTIC_INFRA_URL}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-bold bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors shadow-sm"
              >
              ...
              {isLoading ? (
                ...
                <tr key={lead.id || i} className="border-b border-border hover:bg-muted/20 transition-colors">
                  ...
                  <td className="px-4 py-3 text-[10px] text-muted-foreground font-medium">
                    {lead.signalsCount > 3 ? "/pricing, /demo" : "/blog, /about"}
                  </td>
                  <td className="px-4 py-3 text-[10px] text-muted-foreground font-medium">
