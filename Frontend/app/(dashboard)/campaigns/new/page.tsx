...
export default function WorkflowCanvasPage() {
  ...
  return (
    <ThemeContext.Provider value={T}>
      <div className="h-full flex flex-col overflow-hidden -m-4 sm:-m-6 relative z-10" style={{ background: T.bg, fontFamily: "'Inter', system-ui, -apple-system, sans-serif" }}>
        {/* ── Upper top bar ── */}
        <header className="h-[48px] flex items-center px-5 shrink-0 relative z-40" style={{
          ...
          <div className="flex items-center gap-2">
            <button
               ...
               className="p-1 rounded-md hover:bg-white/5 transition-colors mr-1 cursor-pointer flex items-center justify-center shrink-0"
            >
               <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{color: T.text35}}><path d="m15 18-6-6 6-6"/></svg>
            </button>
