...
export class Web extends Construct {
  ...
  const websiteBucket = new s3.Bucket(this, 'OutmateWebsiteBucket', commonBucketProps);

  const originAccessIdentity = new cloudfront.OriginAccessIdentity(
    this,
    'OriginAccessIdentity',
    {
      comment: 'outmate-distribution-originAccessIdentity',
    }
  );
