...
export class Network extends Construct {
  ...
  constructor(scope: Construct, id: string) {
    ...
    this.alb = new elb.ApplicationLoadBalancer(this,'outmate-alb',{
      internetFacing: true, //インターネットからのアクセスを許可するかどうか指定
      loadBalancerName: 'outmate-alb',
    ...
    this.ecsBackSG = new ec2.SecurityGroup(scope, 'ECSBackEndSecurityGroup', {
      securityGroupName: 'outmate-ecs-back-sg',
      description: 'for outmate-back-ecs',
      vpc: this.vpc,
    })
    ...
    this.dbSG = new ec2.SecurityGroup(scope, 'DBSecurityGroup', {
      ...
      securityGroupName: 'outmate-db',
      description: 'for outmate-db',
      vpc: this.vpc,
    })
    // outmate-ecs-back-sg からのポート3306:mysql(5432:postgres)のインバウンドを許可
    ...
    this.backendLogGroup = new logs.LogGroup(this, 'backendLogGroup', {
      logGroupName: 'outmate-backend-logs',
