...
SED_PATTERN = 's|"outmate-base[^"]*"|"outmate-base[complete]>=0.8.0.rc3,<1.dev0"|g'

TEST_CASES = [
    '    "outmate-base[complete]~=0.8.0",',
    '    "outmate-base~=0.8.0",',
    '    "outmate-base[openai]~=0.8.0",',
    '    "outmate-base[complete]>=0.8.0,<1.dev0",',
    '    "outmate-base[complete]>=0.8.0.rc2,<1.dev0",',
]

EXPECTED = '    "outmate-base[complete]>=0.8.0.rc3,<1.dev0",'
