...
def main():
    ...
    update_pyproject_name("src/backend/base/pyproject.toml", "outmate-base-nightly")
    update_name_uv_dep("pyproject.toml", "outmate-base-nightly")
    ...
    update_pyproject_name("pyproject.toml", "outmate-nightly")
    update_name_uv_dep("pyproject.toml", "outmate-nightly")
