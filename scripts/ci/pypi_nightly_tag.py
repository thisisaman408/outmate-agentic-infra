...
PYPI_OUTMATE_URL = "https://pypi.org/pypi/outmate/json"
PYPI_OUTMATE_NIGHTLY_URL = "https://pypi.org/pypi/outmate-nightly/json"

PYPI_OUTMATE_BASE_URL = "https://pypi.org/pypi/outmate-base/json"
PYPI_OUTMATE_BASE_NIGHTLY_URL = "https://pypi.org/pypi/outmate-base-nightly/json"
...
def get_latest_published_version(build_type: str, *, is_nightly: bool) -> Version:
    url = ""
    if build_type == "base":
        url = PYPI_OUTMATE_BASE_NIGHTLY_URL if is_nightly else PYPI_OUTMATE_BASE_URL
    elif build_type == "main":
        url = PYPI_OUTMATE_NIGHTLY_URL if is_nightly else PYPI_OUTMATE_URL
    else:
