...
[run]
source = src/backend/base/Outmate
omit =
    # Test files
    */tests/*
    */test_*
...
def main():
    ...
    backend_components_path = project_root / "src" / "backend" / "base" / "outmate"/ "components"
    ...
    print("cd src/backend && python -m pytest --cov=src/backend/base/Outmate--cov-config=.coveragerc")
