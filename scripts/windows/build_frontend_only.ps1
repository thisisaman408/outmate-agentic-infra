...
Write-Host "Starting Outmate frontend build process..." -ForegroundColor Green
...
Write-Host "You can now run the backend with: uv run outmate run" -ForegroundColor Cyan
Read-Host "Press Enter to exit"