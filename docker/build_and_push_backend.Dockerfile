...
# Create venv and install outmate-base with dependencies
...
LABEL org.opencontainers.image.title=outmate-backend
...
CMD ["python", "-m", "outmate", "run", "--backend-only"]
