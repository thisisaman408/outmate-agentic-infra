...
async def test_business_events_md5():
    domain = "salesforce.com"
    business_id = hashlib.md5(domain.lower().encode()).hexdigest()
    ...
    print(f"URL: {url}")
    print(f"MD5 Business ID: {business_id}")
...
if __name__ == "__main__":
    asyncio.run(test_business_events_md5())
