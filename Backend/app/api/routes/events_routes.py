...
BUSINESS_EVENT_METADATA: Dict[str, Dict[str, str]] = {
    "ipo_announcement":                          {"label": "IPO Announcement",       "impact": "high",   "category": "Growth", "tier": "Scale"},
    "new_funding_round":                         {"label": "New Funding Round",      "impact": "high",   "category": "Growth", "tier": "Growth"},
    "new_investment":                            {"label": "New Investment",         "impact": "medium", "category": "Growth", "tier": "Growth"},
    "merger_and_acquisitions":                   {"label": "M&A Activity",           "impact": "high",   "category": "Corporate", "tier": "Scale"},
    "cost_cutting":                              {"label": "Cost Cutting",           "impact": "high",   "category": "Risk", "tier": "Starter"},
    "new_partnership":                           {"label": "New Partnership",        "impact": "medium", "category": "Corporate", "tier": "Starter"},
    "new_product":                               {"label": "Product Launch",         "impact": "medium", "category": "Growth", "tier": "Starter"},
    "new_office":                                {"label": "Office Opening",         "impact": "low",    "category": "Growth", "tier": "Free"},
    "closing_office":                            {"label": "Office Closing",         "impact": "medium", "category": "Risk", "tier": "Free"},
    "company_award":                             {"label": "Award / Recognition",    "impact": "low",    "category": "Growth", "tier": "Free"},
    "outages_and_security_breaches":             {"label": "Security Breach",        "impact": "high",   "category": "Risk", "tier": "Growth"},
    "lawsuits_and_legal_issues":                 {"label": "Legal / Lawsuit",        "impact": "high",   "category": "Risk", "tier": "Growth"},
    # Workforce signals (from Signals PDF: "New ICP GTM leader hired", "New CRO/CCO hired")
    "employee_joined_company":                   {"label": "New Executive Hire",     "impact": "high",   "category": "Growth", "tier": "Growth"},
    # Department workforce changes
    "increase_in_all_departments":               {"label": "Workforce Expansion",    "impact": "medium", "category": "Growth", "tier": "Starter"},
    "decrease_in_all_departments":               {"label": "Workforce Reduction",    "impact": "high",   "category": "Risk", "tier": "Starter"},
    "increase_in_engineering_department":        {"label": "Eng Hiring Up",          "impact": "medium", "category": "Growth", "tier": "Starter"},
    "increase_in_sales_department":              {"label": "Sales Hiring Up",        "impact": "medium", "category": "Growth", "tier": "Starter"},
    "increase_in_marketing_department":          {"label": "Marketing Hiring Up",    "impact": "medium", "category": "Growth", "tier": "Starter"},
    "increase_in_operations_department":         {"label": "Ops Hiring Up",          "impact": "low",    "category": "Growth", "tier": "Free"},
    "increase_in_customer_service_department":   {"label": "CS Hiring Up",           "impact": "low",    "category": "Growth", "tier": "Free"},
    "decrease_in_engineering_department":        {"label": "Eng Layoffs",            "impact": "high",   "category": "Risk", "tier": "Starter"},
    "decrease_in_sales_department":              {"label": "Sales Layoffs",          "impact": "high",   "category": "Risk", "tier": "Starter"},
    "decrease_in_marketing_department":          {"label": "Marketing Layoffs",      "impact": "medium", "category": "Risk", "tier": "Starter"},
    "decrease_in_operations_department":         {"label": "Ops Layoffs",            "impact": "medium", "category": "Risk", "tier": "Free"},
    "decrease_in_customer_service_department":   {"label": "CS Layoffs",             "impact": "medium", "category": "Risk", "tier": "Free"},
    # Hiring per department
    "hiring_in_engineering_department":          {"label": "Hiring Engineers",       "impact": "low",    "category": "Growth", "tier": "Free"},
    "hiring_in_sales_department":                {"label": "Hiring Sales",           "impact": "low",    "category": "Growth", "tier": "Free"},
    "hiring_in_marketing_department":            {"label": "Hiring Marketing",       "impact": "low",    "category": "Growth", "tier": "Free"},
    "hiring_in_finance_department":              {"label": "Hiring Finance",         "impact": "low",    "category": "Corporate", "tier": "Free"},
    "hiring_in_human_resources_department":      {"label": "Hiring HR",              "impact": "low",    "category": "Corporate", "tier": "Free"},
    "hiring_in_operations_department":           {"label": "Hiring Operations",      "impact": "low",    "category": "Growth", "tier": "Free"},
    "hiring_in_legal_department":                {"label": "Hiring Legal",           "impact": "low",    "category": "Corporate", "tier": "Free"},
    "hiring_in_support_department":              {"label": "Hiring Support",         "impact": "low",    "category": "Corporate", "tier": "Free"},
    "hiring_in_health_department":               {"label": "Hiring Health",          "impact": "low",    "category": "Growth", "tier": "Free"},
    "hiring_in_education_department":            {"label": "Hiring Education",       "impact": "low",    "category": "Growth", "tier": "Free"},
    "hiring_in_professional_service_department": {"label": "Hiring Prof. Services",  "impact": "low",    "category": "Corporate", "tier": "Free"},
    "hiring_in_creative_department":             {"label": "Hiring Creative",        "impact": "low",    "category": "Growth", "tier": "Free"},
    "hiring_in_trade_department":                {"label": "Hiring Trade",           "impact": "low",    "category": "Corporate", "tier": "Free"},
    "hiring_in_unknown_department":              {"label": "Hiring (Other)",         "impact": "low",    "category": "Corporate", "tier": "Free"},
}

PROSPECT_EVENT_METADATA: Dict[str, Dict[str, str]] = {
    "prospect_changed_company":       {"label": "Company Switch",   "impact": "high",   "category": "People", "tier": "Growth"},
    "prospect_changed_role":          {"label": "Role Change",      "impact": "medium", "category": "People", "tier": "Starter"},
    "prospect_job_start_anniversary": {"label": "Work Anniversary", "impact": "low",    "category": "People", "tier": "Free"},
}
